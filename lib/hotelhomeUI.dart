...
void main() {
  runApp(const HTLhome());
}

class HTLhome extends StatefulWidget {
  const HTLhome({Key? key}) : super(key: key);

  @override
  _HTLhomeState createState() => _HTLhomeState();
}

class _HTLhomeState extends State {
  @override
                      ...
                      Column(children: [
                        Container(
                          ...
                          decoration: BoxDecoration(image: DecorationImage(image: NetworkImage(
                              'https://cdn.pixabay.com/photo/2016/10/18/09/02/hotel-1749602_1280.jpg'),fit: BoxFit.cover)),
